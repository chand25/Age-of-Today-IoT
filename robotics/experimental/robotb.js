...
// my.mip.driveDistance(0, 0, 0, 45);
  ...
  every((2).seconds(), function() {
   ...
   my.mip.flashChestLED(r, g, b, 5, 6);
      ...
      my.mip.turnLeft(45, 5);
      my.mip.turnLeft(45, 5);
      my.mip.driveDistance(0, 10, 2, 45);
      my.mip.driveDistance(1, 10, 2, 45);
   ...
   after((35).seconds(), function() {
      console.log("I'm shutting down now. I need a partner");
      my.mip.stop;
      Cylon.halt();
    });
},
...
flashinglights: function(){
      ...
      let b = (Math.floor(Math.random() * 256));
        ...
        this.mip.flashChestLED(b, r, g, 5, 5);
        this.mip.flashChestLED(g, b, r, 6, 4);
        my.mip.flashChestLED(r, g, b, 5, 6);
    },
